...
|---|---|---|---|
| Editor de código | VS Code + Live Server | Ambiente leve e com recarregamento automático, agilizando a visualização das alterações durante o desenvolvimento | - |
...
| Hospedagem / Versionamento | GitHub | Controle de versão do código-fonte e hospedagem do repositório do projeto | [Acessar](https://github.com/ICEI-PUC-Minas-PMGES-TI/pmg-es-2026-1-ti1-0427100-g5-manutencao-do-predio-escolar/tree/master) |
